      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="10" :xl="10">
        ...
        <el-card shadow="none" style="margin-top: 22px; height: 302px">
          ...
          <div style="cursor: pointer; display: table; width: 100%; line-height: 36px" @click="openDetail(item.noticeId)" v-for="item in noticeList" :key="item.noticeId">
            ...
            <div style="display: table-cell; width: 100px; font-size: 14px">
          ...
          <div style="padding: 30px; font-size: 14px">
            ...
            <div style="float: left">
              ...
              <div style="display: table; margin-bottom: 10px">
                <div style="width: 70px; font-weight: bold; display: table-cell">接入文档</div>
                <div style="display: table-cell">
                  <el-link target="_blank" href="https://iot.yichen.link/doc">iot.yichen.link/doc</el-link>
                </div>
              </div>
              <div style="display: table; margin-bottom: 10px">
                <div style="width: 70px; font-weight: bold; display: table-cell">联系管理</div>
                <div style="display: table-cell">
                  <span>QQ 435395893</span>
                </div>
              </div>
            </div>
          </div>
